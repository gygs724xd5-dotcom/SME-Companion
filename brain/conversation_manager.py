...
def developer_diagnostics(application_state: dict | None) -> dict:
    ...
    return {
        ...
        "response_type": current.get("response_type"),
        "response_source": current.get("response_source"),
        "response_reason": current.get("response_reason"),
        "reuse_completed_workflow": bool(current.get("reuse_completed_workflow")),
        "variant_source": current.get("variant_source"),
        "composer_trace": current.get("composer_trace") or [],
        "followup_chain": current.get("followup_chain") or [],
