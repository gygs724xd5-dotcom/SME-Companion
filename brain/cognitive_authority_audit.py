...
class CognitiveAuthorityAudit:
    ...
    judgment_runtime_consulted: bool = False
    judgment_eligibility_checked: bool = False
    judgment_eligibility_status: str = ""
    judgment_candidate_registry_consulted: bool = False
    judgment_candidate_registry_version: str = ""
    judgment_candidate_ids_considered: list = field(default_factory=list)
    judgment_candidate_ids_excluded: list = field(default_factory=list)
    judgment_candidate_count: int = 0
    judgment_selected: bool = False
    judgment_status: str = ""
    judgment_type: str = ""
    judgment_support_strength: str = ""
    judgment_confidence_class: str = ""
    judgment_supporting_evidence: list = field(default_factory=list)
    judgment_contradicting_evidence: list = field(default_factory=list)
    judgment_missing_evidence: list = field(default_factory=list)
    judgment_alternatives_preserved: bool = False
    judgment_assumption_count: int = 0
    judgment_high_risk_assumption_detected: bool = False
    judgment_causal_claim_level: str = ""
    judgment_evidence_weighting_consulted: bool = False
    judgment_weighting_policy_version: str = ""
    evidence_double_count_prevented: bool = False
    candidate_evidence_profiles_created: bool = False
    alternative_comparison_performed: bool = False
    alternative_comparison_status: str = ""
    dominant_candidate: str = ""
    coexisting_candidates: list = field(default_factory=list)
    plausible_alternatives: list = field(default_factory=list)
    selection_margin: str = ""
    confirmation_bias_guard_applied: bool = False
    next_separator_evidence: list = field(default_factory=list)
    judgment_outcome_hardening_consulted: bool = False
    judgment_outcome_status: str = ""
    judgment_response_mode: str = ""
    judgment_safe_claim_count: int = 0
    judgment_suppressed_claim_count: int = 0
    judgment_claim_trace_complete: bool = False
    judgment_language_consistency_checked: bool = False
    judgment_overstatement_prevented: bool = False
    judgment_scope_guard_applied: bool = False
    judgment_timeframe_guard_applied: bool = False
    judgment_benchmark_guard_applied: bool = False
    judgment_alternative_omission_checked: bool = False
    judgment_recommendation_leak_prevented: bool = False
    judgment_decision_leak_prevented: bool = False
    judgment_planner_leak_prevented: bool = False
    judgment_workflow_trigger_leak_prevented: bool = False
    judgment_outcome_validator_passed: bool = False
    judgment_ready_for_future_decision: bool = False
    workflow_started_by_judgment: bool = False
    business_memory_mutated_by_judgment: bool = False
...
def build_cognitive_authority_audit(task_route: dict | None = None, **overrides: Any) -> dict:
    ...
    business_judgment = _as_dict(_as_dict(business_situation.get("diagnostics")).get("business_judgment"))
    judgment_response_handoff = _as_dict(_as_dict(business_situation.get("diagnostics")).get("judgment_response_handoff"))
    judgment_diagnostics = _as_dict(business_judgment.get("diagnostics"))
    judgment_outcome = _as_dict(judgment_response_handoff.get("outcome"))
    judgment_outcome_diagnostics = _as_dict(judgment_outcome.get("diagnostics"))
    selected_judgment = _as_dict(business_judgment.get("selected_judgment"))
    selected_explanation = _as_dict(selected_judgment.get("selected_explanation"))
    ...
    audit = CognitiveAuthorityAudit(
        ...
        judgment_runtime_consulted=bool(judgment_diagnostics.get("judgment_runtime_consulted")),
        judgment_eligibility_checked=bool(judgment_diagnostics.get("judgment_eligibility_checked")),
        judgment_eligibility_status=judgment_diagnostics.get("judgment_eligibility_status") or "",
        judgment_candidate_registry_consulted=bool(judgment_diagnostics.get("judgment_candidate_registry_consulted")),
        judgment_candidate_registry_version=judgment_diagnostics.get("judgment_candidate_registry_version") or "",
        judgment_candidate_ids_considered=judgment_diagnostics.get("judgment_candidate_ids_considered") or [],
        judgment_candidate_ids_excluded=judgment_diagnostics.get("judgment_candidate_ids_excluded") or [],
        judgment_candidate_count=int(judgment_diagnostics.get("judgment_candidate_count") or 0),
        judgment_selected=bool(judgment_diagnostics.get("judgment_selected")),
        judgment_status=judgment_diagnostics.get("judgment_status") or business_judgment.get("judgment_status") or "",
        judgment_type=judgment_diagnostics.get("judgment_type") or selected_judgment.get("judgment_type") or "",
        judgment_support_strength=judgment_diagnostics.get("judgment_support_strength") or business_judgment.get("support_strength") or "",
        judgment_confidence_class=judgment_diagnostics.get("judgment_confidence_class") or business_judgment.get("confidence_class") or "",
        judgment_supporting_evidence=selected_explanation.get("supporting_evidence") or selected_judgment.get("supporting_evidence") or [],
        judgment_contradicting_evidence=selected_explanation.get("contradicting_evidence") or selected_judgment.get("contradicting_evidence") or [],
        judgment_missing_evidence=selected_explanation.get("missing_evidence") or selected_judgment.get("missing_evidence") or [],
        judgment_alternatives_preserved=bool(business_judgment.get("alternative_explanations")),
        judgment_assumption_count=len(selected_judgment.get("assumptions") or []),
        judgment_high_risk_assumption_detected=any(_as_dict(item).get("risk_level") in {"HIGH", "UNACCEPTABLE"} for item in selected_judgment.get("assumptions") or []),
        judgment_causal_claim_level=selected_explanation.get("causal_claim_level") or "",
        judgment_evidence_weighting_consulted=bool(judgment_diagnostics.get("judgment_evidence_weighting_consulted")),
        judgment_weighting_policy_version=((business_judgment.get("evidence_summary") or {}).get("weighted_evidence") or {}).get("version") or "",
        evidence_double_count_prevented=bool(judgment_diagnostics.get("evidence_double_count_prevented")),
        candidate_evidence_profiles_created=bool(judgment_diagnostics.get("candidate_evidence_profiles_created")),
        alternative_comparison_performed=bool(judgment_diagnostics.get("alternative_comparison_performed")),
        alternative_comparison_status=judgment_diagnostics.get("alternative_comparison_status") or "",
        dominant_candidate=judgment_diagnostics.get("dominant_candidate") or "",
        coexisting_candidates=judgment_diagnostics.get("coexisting_candidates") or [],
        plausible_alternatives=judgment_diagnostics.get("plausible_alternatives") or [],
        selection_margin=judgment_diagnostics.get("selection_margin") or "",
        confirmation_bias_guard_applied=bool(judgment_diagnostics.get("confirmation_bias_guard_applied")),
        next_separator_evidence=judgment_diagnostics.get("next_separator_evidence") or [],
        judgment_outcome_hardening_consulted=bool(judgment_outcome_diagnostics.get("judgment_outcome_hardening_consulted")),
        judgment_outcome_status=judgment_outcome_diagnostics.get("judgment_outcome_status") or "",
        judgment_response_mode=judgment_outcome_diagnostics.get("judgment_response_mode") or "",
        judgment_safe_claim_count=int(judgment_outcome_diagnostics.get("judgment_safe_claim_count") or 0),
        judgment_suppressed_claim_count=int(judgment_outcome_diagnostics.get("judgment_suppressed_claim_count") or 0),
        judgment_claim_trace_complete=bool(judgment_outcome_diagnostics.get("judgment_claim_trace_complete")),
        judgment_language_consistency_checked=bool(judgment_outcome_diagnostics.get("judgment_language_consistency_checked")),
        judgment_overstatement_prevented=bool(judgment_outcome_diagnostics.get("judgment_overstatement_prevented")),
        judgment_scope_guard_applied=bool(judgment_outcome_diagnostics.get("judgment_scope_guard_applied")),
        judgment_timeframe_guard_applied=bool(judgment_outcome_diagnostics.get("judgment_timeframe_guard_applied")),
        judgment_benchmark_guard_applied=bool(judgment_outcome_diagnostics.get("judgment_benchmark_guard_applied")),
        judgment_alternative_omission_checked=bool(judgment_outcome_diagnostics.get("judgment_alternative_omission_checked")),
        judgment_recommendation_leak_prevented=bool(judgment_outcome_diagnostics.get("judgment_recommendation_leak_prevented")),
        judgment_decision_leak_prevented=bool(judgment_outcome_diagnostics.get("judgment_decision_leak_prevented")),
        judgment_planner_leak_prevented=bool(judgment_outcome_diagnostics.get("judgment_planner_leak_prevented")),
        judgment_workflow_trigger_leak_prevented=bool(judgment_outcome_diagnostics.get("judgment_workflow_trigger_leak_prevented")),
        judgment_outcome_validator_passed=bool(judgment_outcome_diagnostics.get("judgment_outcome_validator_passed")),
        judgment_ready_for_future_decision=bool(judgment_outcome_diagnostics.get("judgment_ready_for_future_decision")),
        ...
        diagnostic_summary={
            ...
            "workflow_admission_gate": {
                ...
                "explicit_calculation_request_detected": admission_gate.get("explicit_calculation_request_detected"),
                "analytical_question_detected": admission_gate.get("analytical_question_detected"),
                "analytical_statement_detected": admission_gate.get("analytical_statement_detected"),
                "comparison_change_detected": admission_gate.get("comparison_change_detected"),
                "correction_detected": admission_gate.get("correction_detected"),
                "workflow_admission_suppressed_reason": admission_gate.get("workflow_admission_suppressed_reason"),
