...
def _with_diagnostic_groups(diagnostics: dict) -> dict:
    grouped = {
        ...
        "Perspective": {
            ...
            "candidate_frames": diagnostics.get("perspective_candidate_frames"),
            ...
            "frame_evidence": diagnostics.get("perspective_frame_evidence"),
            "frame_contradictions": diagnostics.get("perspective_frame_contradictions"),
            "frame_source_signals": diagnostics.get("perspective_frame_source_signals"),
            "classification_performed": diagnostics.get("perspective_classification_performed"),
            "classification_method": diagnostics.get("perspective_classification_method"),
            "frame_registry_version": diagnostics.get("perspective_frame_registry_version"),
            "registered_frame_count": diagnostics.get("perspective_registered_frame_count"),
            "registered_frame_ids": diagnostics.get("perspective_registered_frame_ids"),
            "registry_version": diagnostics.get("perspective_registry_version"),
        ...
        "Cognitive Authority": {
            ...
            "perspective_classification_performed": diagnostics.get("cognitive_authority_perspective_classification_performed"),
            "perspective_selected_frame": diagnostics.get("cognitive_authority_perspective_selected_frame"),
            "perspective_candidate_frames": diagnostics.get("cognitive_authority_perspective_candidate_frames"),
            "perspective_frame_confidence": diagnostics.get("cognitive_authority_perspective_frame_confidence"),
            "perspective_frame_status": diagnostics.get("cognitive_authority_perspective_frame_status"),
            "perspective_consulted_by_clarification": diagnostics.get("cognitive_authority_perspective_consulted_by_clarification"),
            "perspective_authoritative_for_framing": diagnostics.get("cognitive_authority_perspective_authoritative_for_framing"),
            "perspective_authoritative_for_routing": diagnostics.get("cognitive_authority_perspective_authoritative_for_routing"),
            "perspective_authoritative_for_workflow": diagnostics.get("cognitive_authority_perspective_authoritative_for_workflow"),
            "perspective_authoritative_for_response": diagnostics.get("cognitive_authority_perspective_authoritative_for_response"),
...
def developer_diagnostics(task_route: dict | None) -> dict:
    ...
    diagnostics = {
        ...
        "cognitive_authority_perspective_classification_performed": bool(cognitive_authority_audit.get("perspective_classification_performed")),
        "cognitive_authority_perspective_selected_frame": cognitive_authority_audit.get("perspective_selected_frame"),
        "cognitive_authority_perspective_candidate_frames": cognitive_authority_audit.get("perspective_candidate_frames") or [],
        "cognitive_authority_perspective_frame_confidence": cognitive_authority_audit.get("perspective_frame_confidence"),
        "cognitive_authority_perspective_frame_status": cognitive_authority_audit.get("perspective_frame_status"),
        "cognitive_authority_perspective_consulted_by_clarification": bool(cognitive_authority_audit.get("perspective_consulted_by_clarification")),
        "cognitive_authority_perspective_authoritative_for_framing": bool(cognitive_authority_audit.get("perspective_authoritative_for_framing")),
        "cognitive_authority_perspective_authoritative_for_routing": bool(cognitive_authority_audit.get("perspective_authoritative_for_routing")),
        "cognitive_authority_perspective_authoritative_for_workflow": bool(cognitive_authority_audit.get("perspective_authoritative_for_workflow")),
        "cognitive_authority_perspective_authoritative_for_response": bool(cognitive_authority_audit.get("perspective_authoritative_for_response")),
        ...
        "perspective_candidate_frames": perspective_runtime.get("candidate_frames") or [],
        ...
        "perspective_frame_evidence": perspective_runtime.get("frame_evidence") or perspective_diagnostics.get("frame_evidence") or {},
        "perspective_frame_contradictions": perspective_runtime.get("frame_contradictions") or perspective_diagnostics.get("frame_contradictions") or {},
        "perspective_frame_source_signals": perspective_runtime.get("frame_source_signals") or perspective_diagnostics.get("frame_source_signals") or [],
        "perspective_classification_performed": bool(perspective_runtime.get("classification_performed") or perspective_diagnostics.get("classification_performed")),
        "perspective_classification_method": perspective_runtime.get("classification_method") or perspective_diagnostics.get("classification_method"),
        "perspective_frame_registry_version": perspective_runtime.get("frame_registry_version") or perspective_diagnostics.get("frame_registry_version"),
        "perspective_registered_frame_count": perspective_diagnostics.get("registered_frame_count"),
        "perspective_registered_frame_ids": perspective_diagnostics.get("registered_frame_ids") or [],
        "perspective_registry_version": perspective_diagnostics.get("registry_version"),
