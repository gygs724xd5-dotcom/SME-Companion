...
class V410FoundationPipelineTest(unittest.TestCase):
    ...
    def test_transformation_chain_does_not_skip_planner(self):
        ...
        for message, expected_type in sequence:
            ...
            self.assertNotEqual(route.get("continuation_mode"), "response_transformation")
    ...
    def test_diagnostics_are_grouped_without_removing_flat_fields(self):
        ...
        self.assertIsNone(diagnostics["transformation_type"])
        ...
        self.assertFalse(diagnostics["diagnostic_groups"]["Planner"]["planner_skipped"])
        self.assertIsNone(diagnostics["diagnostic_groups"]["Transformation"]["transformation_type"])
